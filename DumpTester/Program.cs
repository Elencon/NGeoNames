...
class Program
{
    ...
    static void Main(string[] args)
    {
        ...
        dumpfiles.AsParallel().ForAll(g =>
        {
            ...
            Console.WriteLine($"Testing {g.Filename}: {g.Test(Path.Combine(Dump_DownloadDirectory, g.Filename))}");
        });
        ...
        postalcodefiles.AsParallel().ForAll(g =>
        {
            ...
            Console.WriteLine($"Testing {g.Filename}: {g.Test(Path.Combine(Postal_DownloadDirectory, g.Filename))}");
        });
