...
public class PostalcodeParser : BaseParser<Postalcode>
{
    ...
    /// </summary>
    public override int ExpectedNumberOfFields => 12;
    ...
    public override Postalcode Parse(string[] fields)
    {
        return new Postalcode
        {
            ...
            PostalCode = fields[1],
            PlaceName = fields[2],
            AdminName = [fields[3], fields[5], fields[7]],
            AdminCode = [fields[4], fields[6], fields[8]],
            ...
            Accuracy = fields[11].Length > 0 ? StringToInt(fields[11]) : null
        };
    }
}
