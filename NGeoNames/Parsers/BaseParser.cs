...
public abstract class BaseParser<T> : IParser<T>
{
    ...
    protected int StringToInt(string value) => int.Parse(value);
    ...
    protected long StringToLong(string value) => long.Parse(value);
    ...
    protected string[] StringToArray(string value) => StringToArray(value, csv);
    ...
    protected string StringToTimeZone(string value) => value.Replace("_", " ");
}