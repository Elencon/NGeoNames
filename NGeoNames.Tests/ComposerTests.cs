...
public class ComposerTests
{
    ...
    public void Admin1CodesComposer_ComposesFileCorrectly()
    {
        ...
        FileUtil.EnsureFilesAreFunctionallyEqual(src, dst, 4, 0, ['\t'], Encoding.UTF8, false);
    }
    ...
    public void AlternateNamesComposer_ComposesFileCorrectly()
    {
        ...
        FileUtil.EnsureFilesAreFunctionallyEqual(src, dst, 8, 0, ['\t'], Encoding.UTF8, false);
    }
    ...
    public void AlternateNamesComposerV2_ComposesFileCorrectly()
    {
        ...
        FileUtil.EnsureFilesAreFunctionallyEqual(src, dst, 10, 0, ['\t'], Encoding.UTF8, false);
    }
    ...
    public void ContinentComposer_ComposesFileCorrectly()
    {
        ...
        FileUtil.EnsureFilesAreFunctionallyEqual(src, dst, 3, 0, ['\t'], Encoding.UTF8, true);
    }
    ...
    public void CountryInfoComposer_ComposesFileCorrectly()
    {
        ...
        FileUtil.EnsureFilesAreFunctionallyEqual(src, dst, 19, 0, ['\t'], Encoding.UTF8, true);
    }
    ...
    public void ExtendedGeoNamesComposer_ComposesFileCorrectly()
    {
        ...
        FileUtil.EnsureFilesAreFunctionallyEqual(src, dst, 19, 0, ['\t'], Encoding.UTF8, false);
    }
    ...
    public void FeatureClassComposer_ComposesFileCorrectly()
    {
        ...
        FileUtil.EnsureFilesAreFunctionallyEqual(src, dst, 2, 0, ['\t'], Encoding.UTF8, true);
    }
    ...
    public void HierarchyComposer_ComposesFileCorrectly()
    {
        ...
        FileUtil.EnsureFilesAreFunctionallyEqual(src, dst, 3, 0, ['\t'], Encoding.UTF8, false);
    }
    ...
    public void ISOLanguageCodeComposer_ComposesFileCorrectly()
    {
        ...
        FileUtil.EnsureFilesAreFunctionallyEqual(src, dst, 4, 1, ['\t'], Encoding.UTF8, false);
    }
    ...
    public void TimeZoneComposer_ComposesFileCorrectly()
    {
        ...
        FileUtil.EnsureFilesAreFunctionallyEqual(src, dst, 5, 1, ['\t'], Encoding.UTF8, false);
    }
    ...
    public void UserTagComposer_ComposesFileCorrectly()
    {
        ...
        FileUtil.EnsureFilesAreFunctionallyEqual(src, dst, 2, 0, ['\t'], Encoding.UTF8, false);
    }
    ...
    public void PostalcodeComposer_ComposesFileCorrectly()
    {
        ...
        FileUtil.EnsureFilesAreFunctionallyEqual(src, dst, 12, 0, ['\t'], Encoding.UTF8, false);
    }
    ...
    public void CustomComposer_ComposesFileCorrectly()
    {
        ...
        new GeoFileWriter().WriteRecords(dst, new GeoFileReader().ReadRecords(src, new CustomParser(19, 5, ['☃'], Encoding.UTF7, true)), new CustomComposer(Encoding.UTF7, '☃'));

        FileUtil.EnsureFilesAreFunctionallyEqual(src, dst, 19, 5, ['☃'], Encoding.UTF7, true);
    }
