...
public class ParserTests
{
    ...
    {
        var target = new GeoFileReader().ReadRecords(@"testdata\test_custom.txt", new CustomParser(19, 5, ['☃'], Encoding.UTF7, true)).ToArray();
    ...
    public void FileReader_HandlesEmptyFilesCorrectly()
    {
        ...
        var target1 = new GeoFileReader().ReadRecords(@"testdata\emptyfile.txt", new CustomParser(19, 5, ['☃'], Encoding.UTF7, true)).ToArray();
