...
{
    private static readonly CustomEntity[] testvalues = [
        new CustomEntity { Data = ["Data L1☃F1", "Data L1☃F2", "Data L1☃F3"]},
        new CustomEntity { Data = ["Data L2☃F1", "Data L2☃F2", "Data L2☃F3"]},
        new CustomEntity { Data = ["Data L3☃F1", "Data L3☃F2", "Data L3☃F3"]},
    ];
    ...
    public void GeoFileWriter_ComposesFileCorrectly1()
    {
        ...
        var target = gf.ReadRecords(@"testdata\test_geofilewritercustom1.txt", new CustomParser(3, 0, [','], Encoding.UTF8, false)).ToArray();
    ...
    public void GeoFileWriter_ComposesFileCorrectly2()
    {
        ...
        var gf = new GeoFileReader();
        var target = gf.ReadRecords(@"testdata\test_geofilewritercustom2.txt", new CustomParser(3, 0, ['!'], Encoding.UTF7, false)).ToArray();
        Assert.AreEqual(3, target.Length);
        CollectionAssert.AreEqual(testvalues, target, new CustomEntityComparer());
    }
